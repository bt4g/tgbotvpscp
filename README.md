...
<p align="center">
  <b >v1.13.0</b> — мощный Telegram-бот для мониторинга и управления вашей <b>сетью серверов</b>. Теперь на базе <b>SQLite</b> и полностью <b>асинхронного ядра</b> (AsyncIO). Поддержка <b>множества нод</b>, веб-интерфейс и полная интеграция с <b>Docker</b>.
</p>
...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/build-51-purple?style=flat-square" alt="Build 51"/></a>
