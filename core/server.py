...
async def handle_dashboard(request):
    ...
    replacements = {
        "{web_title}": f"{_('web_dashboard_title', lang)} - VPS Bot", "{web_version}": APP_VERSION.lstrip('v'), "{cache_ver}": CACHE_VER, "{web_dashboard_title}": _("web_dashboard_title", lang), "{role_badge}": role_badge_html, "{user_avatar}": _get_avatar_html(user), "{user_name}": user.get('first_name', 'User'), "{nodes_count}": str(nodes_count), "{active_nodes}": str(active_nodes), "{web_agent_stats_title}": _("web_agent_stats_title", lang), "{agent_ip}": AGENT_IP_CACHE, "{web_traffic_total}": _("web_traffic_total", lang), "{web_uptime}": _("web_uptime", lang), "{web_cpu}": _("web_cpu", lang), "{web_ram}": _("web_ram", lang), "{web_disk}": _("web_disk", lang), "{web_rx}": _("web_rx", lang), "{web_tx}": _("web_tx", lang), "{web_download}": _("web_download", lang), "{web_upload}": _("web_upload", lang), "{web_node_mgmt_title}": _("web_node_mgmt_title", lang), "{web_logs_title}": _("web_logs_title", lang), "{web_logs_footer}": _("web_logs_footer", lang), "{web_loading}": _("web_loading", lang), "{web_nodes_loading}": _("web_nodes_loading", lang), "{web_logs_btn_bot}": "Логи Бота" if lang == 'ru' else "Bot Logs", "{web_logs_btn_sys}": "Логи VPS" if lang == 'ru' else "VPS Logs", "{node_action_btn}": node_action_btn, "{settings_btn}": settings_btn, "{web_footer_powered}": _("web_footer_powered", lang), "{web_hint_cpu_usage}": _("web_hint_cpu_usage", lang), "{web_hint_ram_usage}": _("web_hint_ram_usage", lang), "{web_hint_disk_usage}": _("web_hint_disk_usage", lang), "{web_hint_traffic_in}": _("web_hint_traffic_in", lang), "{web_hint_traffic_out}": _("web_hint_traffic_out", lang), "{web_add_node_section}": _("web_add_node_section", lang), "{web_node_name_placeholder}": _("web_node_name_placeholder", lang), "{web_create_btn}": _("web_create_btn", lang), "{web_node_token}": _("web_node_token", lang), "{web_node_cmd}": _("web_node_cmd", lang), "{web_copied}": _("web_copied", lang), "{web_resources_chart}": _("web_resources_chart", lang), "{web_network_chart}": _("web_network_chart", lang), "{web_token_label}": _("web_token_label", lang), "{web_stats_total}": _("web_stats_total", lang), "{web_stats_active}": _("web_stats_active", lang), "{web_notifications_title}": _("web_notifications_title", lang), "{web_clear_notifications}": _("web_clear_notifications", lang), "{web_node_details_title}": _("web_node_details_title", lang), "{web_clear_logs_btn}": _("web_clear_logs_btn", lang), "{web_logout}": _("web_logout", lang), "{web_access_denied}": _("web_access_denied", lang), "{web_logs_protected_desc}": _("web_logs_protected_desc", lang), "{user_role_js}": f"const USER_ROLE = '{role}';", "{web_search_placeholder}": _("web_search_placeholder", lang),
    }
    for k, v in replacements.items(): html = html.replace(k, str(v))
    i18n_data = {
        "web_cpu": _("web_cpu", lang), "web_ram": _("web_ram", lang), "web_no_nodes": _("web_no_nodes", lang), "web_loading": _("web_loading", lang), "web_error": _("web_error", lang, error=""), "web_conn_error": _("web_conn_error", lang, error=""), "web_log_empty": _("web_log_empty", lang), "web_access_denied": _("web_access_denied", lang), "web_copied": _("web_copied", lang), "web_no_notifications": _("web_no_notifications", lang), "web_clear_notifications": _("web_clear_notifications", lang), "modal_title_alert": _("modal_title_alert", lang), "modal_title_confirm": _("modal_title_confirm", lang), "web_clear_notif_confirm": _("web_clear_notifications", lang) + "?", "modal_btn_ok": _("modal_btn_ok", lang), "modal_btn_cancel": _("modal_btn_cancel", lang), "web_time_d": _("unit_day_short", lang), "web_time_h": _("unit_hour_short", lang), "web_time_m": _("unit_minute_short", lang), "unit_bytes": _("unit_bytes", lang), "unit_kb": _("unit_kb", lang), "unit_mb": _("unit_mb", lang), "unit_gb": _("unit_gb", lang), "unit_tb": _("unit_tb", lang), "unit_pb": _("unit_pb", lang), "web_search_nothing_found": _("web_search_nothing_found", lang),
    }
...
async def handle_settings_page(request):
    ...
    replacements = {
        "{web_title}": f"{_('web_settings_page_title', lang)} - Web Bot", "{user_name}": user.get('first_name'), "{user_avatar}": _get_avatar_html(user), "{users_data_json}": users_json, "{nodes_data_json}": nodes_json, "{keyboard_config_json}": keyboard_config_json, "{val_cpu}": str(current_config.CPU_THRESHOLD), "{val_ram}": str(current_config.RAM_THRESHOLD), "{val_disk}": str(current_config.DISK_THRESHOLD), "{val_traffic}": str(current_config.TRAFFIC_INTERVAL), "{val_timeout}": str(current_config.NODE_OFFLINE_TIMEOUT), "{web_settings_page_title}": _("web_settings_page_title", lang), "{web_back}": _("web_back", lang), "{web_notif_section}": _("web_notif_section", lang), "{notifications_alert_name_res}": _("notifications_alert_name_res", lang), "{notifications_alert_name_logins}": _("notifications_alert_name_logins", lang), "{notifications_alert_name_bans}": _("notifications_alert_name_bans", lang), "{notifications_alert_name_downtime}": _("notifications_alert_name_downtime", lang), "{web_save_btn}": _("web_save_btn", lang), "{web_users_section}": _("web_users_section", lang), "{web_add_user_btn}": _("web_add_user_btn", lang), "{web_user_id}": _("web_user_id", lang), "{web_user_name}": _("web_user_name", lang), "{web_user_role}": _("web_user_role", lang), "{web_user_action}": _("web_user_action", lang), "{web_add_node_section}": _("web_add_node_section", lang), "{web_node_name_placeholder}": _("web_node_name_placeholder", lang), "{web_no_users}": _("web_no_users", lang), "{web_create_btn}": _("web_create_btn", lang), "{web_node_token}": _("web_node_token", lang), "{web_node_cmd}": _("web_node_cmd", lang), "{web_sys_settings_section}": _("web_sys_settings_section", lang), "{web_thresholds_title}": _("web_thresholds_title", lang), "{web_intervals_title}": _("web_intervals_title", lang), "{web_logs_mgmt_title}": _("web_logs_mgmt_title", lang), "{web_cpu_threshold}": _("web_cpu_threshold", lang), "{web_ram_threshold}": _("web_ram_threshold", lang), "{web_disk_threshold}": _("web_disk_threshold", lang), "{web_traffic_interval}": _("web_traffic_interval", lang), "{web_node_timeout}": _("web_node_timeout", lang), "{web_clear_logs_btn}": _("web_clear_logs_btn", lang), "{web_security_section}": _("web_security_section", lang), "{web_change_password_title}": _("web_change_password_title", lang), "{web_current_password}": _("web_current_password", lang), "{web_new_password}": _("web_new_password", lang), "{web_confirm_password}": _("web_confirm_password", lang), "{web_change_btn}": _("web_change_btn", lang), "{web_hint_cpu_threshold}": _("web_hint_cpu_threshold", lang), "{web_hint_ram_threshold}": _("web_hint_ram_threshold", lang), "{web_hint_disk_threshold}": _("web_hint_disk_threshold", lang), "{web_hint_traffic_interval}": _("web_hint_traffic_interval", lang), "{web_hint_node_timeout}": _("web_hint_node_timeout", lang), "{web_keyboard_title}": _("web_keyboard_title", lang), "{web_soon_placeholder}": _("web_soon_placeholder", lang), "{web_node_mgmt_title}": _("web_node_mgmt_title", lang), "{web_kb_desc}": _("web_kb_desc", lang), "{web_kb_btn_config}": _("web_kb_btn_config", lang), "{web_kb_enable_all}": _("web_kb_enable_all", lang), "{web_kb_disable_all}": _("web_kb_disable_all", lang), "{web_kb_modal_title}": _("web_kb_modal_title", lang), "{web_kb_done}": _("web_kb_done", lang), "{web_version}": CACHE_VER, "{web_update_section}": _("web_update_section", lang), "{web_update_placeholder}": _("web_update_placeholder", lang), "{web_update_check_btn}": _("web_update_check_btn", lang), "{web_update_do_btn}": _("web_update_do_btn", lang), "{web_notifications_title}": _("web_notifications_title", lang), "{web_clear_notifications}": _("web_clear_notifications", lang), "{web_logout}": _("web_logout", lang), "{web_sessions_title}": _("web_sessions_title", lang), "{web_sessions_view_all}": _("web_sessions_view_all", lang), "{web_sessions_revoke_all}": _("web_sessions_revoke_all", lang), "{web_sessions_modal_title}": _("web_sessions_modal_title", lang), "{user_role_js}": f"const USER_ROLE = '{role}';", "{web_sessions_title}": _("web_sessions_title", lang),
    }
    modified_html = html
...
async def handle_login_page(request):
    ...
    # --- Multi-language support injection ---
    keys = [
    ...
    if "{i18n_json}" in html: 
        html = html.replace("{i18n_json}", injection)
