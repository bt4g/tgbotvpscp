    ...
    while True:
        ...
        for user_id in current_users:
            ...
            try:
                ...
                keyboard = InlineKeyboardMarkup(inline_keyboard=[[stop_button]])
                msg_text = f"{get_text('traffic_update_total', lang)}\n=========================\n{get_text('traffic_rx', lang, value=format_traffic(rx, lang))}\n{get_text('traffic_tx', lang, value=format_traffic(tx, lang))}\n\n{get_text('traffic_update_speed', lang)}\n=========================\n{get_text('traffic_speed_rx', lang, speed=rx_speed)}\n{get_text('traffic_speed_tx', lang, speed=tx_speed)}"
